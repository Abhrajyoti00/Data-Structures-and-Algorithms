...
#     def rightRotate(self, currentDisbalancedNode):
...
#         #Updating Heights
#         currentDisbalancedNode.height =  1 + max(self.getHeight(currentDisbalancedNode.left),
#                         self.getHeight(currentDisbalancedNode.right))
#         newRoot.height = 1 + max(self.getHeight(newRoot.left),
#                         self.getHeight(newRoot.right))

#         return newRoot
    
#     def leftRotate(self, currentDisbalancedNode):
